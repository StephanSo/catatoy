...
let tranche25 = new TrancheAge(1,"tranche25",2,5)
lesTranches.push(tranche25);
let tranche48 = new TrancheAge(1,"tranche48",4,8)
lesTranches.push(tranche48);

let lesCateg = [];
let categorie1 = new Categorie(1,"Plein Air");
lesCateg.push(categorie1);
let categorie2 = new Categorie(1,"Jeux d'imagination");
lesCateg.push(categorie2);
let categorie3 = new Categorie(1,"Jeux d'eveil");
